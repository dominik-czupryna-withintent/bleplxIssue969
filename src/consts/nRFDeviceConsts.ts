...
export const writeWithResponseBase64Time = getDateAsBase64(
  new Date('2022-08-11T08:17:19Z'),
);
export const writeWithoutResponseBase64Time = getDateAsBase64(
  new Date('2023-09-12T10:12:16Z'),
);
export const monitorExpectedMessage = 'Hi, it works!';
export const currentTimeCharacteristicTimeTriggerDescriptorValue =
  base64.encode('BLE-PLX');
